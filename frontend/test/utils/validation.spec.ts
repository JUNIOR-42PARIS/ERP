...
describe('isNameTextLengthValid', () => {
  ...
  it('should be true', () => {
    ...
    expect(isNameTextLengthValid()('   AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA   ')).toBe(
      true
    );
    expect(isNameTextLengthValid()('   A                                                   ')).toBe(
      true
    );
    expect(isNameTextLengthValid(0, 20)('                                                  ')).toBe(
      true
    );
  ...
  it('should hit maximum', () => {
    ...
    expect(isNameTextLengthValid(1, 2)('   012   ')).toBe(
