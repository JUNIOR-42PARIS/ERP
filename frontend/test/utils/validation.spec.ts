...
describe("isValidSiren", () => {
  ...
  it('should be string', () => {
    expect(isValidSiren()('')).toBe("Le SIREN doit être composé de 15 chiffres");
    expect(isValidSiren()('012345678')).toBe("Le SIREN doit être composé de 15 chiffres");
...
describe("isNameTextLengthValid", () => {
  ...
  it("should be true", () => {
    ...
    expect(isNameTextLengthValid()('   AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA   ')).toBe(true);
    expect(isNameTextLengthValid()('   A                                                   ')).toBe(true);
    expect(isNameTextLengthValid(0, 20)('                                                  ')).toBe(true);
    expect(isNameTextLengthValid(1, 2)('1')).toBe(true);
  });

  it("should hit minimum", () => {
    expect(isNameTextLengthValid()('')).toBe('Le texte est trop court (au moins 1 caractères)');
    expect(isNameTextLengthValid(10)('012345678')).toBe('Le texte est trop court (au moins 10 caractères)');
    expect(isNameTextLengthValid(10)('   012345678   ')).toBe('Le texte est trop court (au moins 10 caractères)');
  });
